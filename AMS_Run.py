...
window = tk.Tk()
window.title("Online Attendence Evaluation System")
...
def subjectchoose():
                ...
                while True:
                    ...
                    for (x, y, w, h) in faces:
                        ...
                        if (conf <70):
                            ...
                            global tt
                            tt = str(Id) + "-" + aa+" "+str(round(conf))
                            En = '15624031' + str(Id)
                            attendance.loc[len(attendance)] = [Id, aa, date, timeStamp]
                            cv2.rectangle(im, (x, y), (x + w, y + h), (0, 260, 0), 7)
                            cv2.putText(im, str(tt), (x, y), font, 1, (255, 255, 0,), 4)
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"C:\Users\saiva\OneDrive\Desktop\mini\Online-Attendence-Evaluation-System\Attendance\"')
    ...
    def log_in():
        ...
        if username == 'vamshi' :
            if password == '12345':
                ...
                cs = r"C:\Users\saiva\OneDrive\Desktop\mini\Online-Attendence-Evaluation-System\StudentDetails\StudentDetails.csv"
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
message = tk.Label(window, text="Online Attendence Evaluation System", bg="pink", fg="black", width=50,
...
AP = tk.Button(window, text="Check Register students",command=admin_panel,fg="black"  ,bg="yellow"  ,width=19 ,height=1, activebackground = "Red" ,font=('times', 15, ' bold '))
...
quitWindow = tk.Button(window, text="close", command=window.destroy  ,fg="black"  ,bg="lawn green"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
